...
# =====================================================
# GENERATE SCHEDULE + FIX BLOCK (aangepast met max 4 wissels per blok + max 2 per keer + vloeibare tijden)
# =====================================================
def generate_schedule(players, targets, priority_flags, blocks):
    ...
    for b_name, b_min in blocks:
        ...
        def assign(idx):
            ...
            cands = [p for p in players if p not in used and position_rank(p, pos) <= 3 and remaining[p] - b_min >= -20]
